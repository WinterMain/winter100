...
layout: post
title:  简体繁体在线转换工具
date:   2020-03-25T06:53:14.000Z
description: 简体繁体在线转换工具，把需要转换的内容粘贴至文本输入框，点击转化为简体或者转为繁体。繁体字，也称繁体中文，欧美各国称之为“传统中文（Traditional Ch...
img: https://www.samyoc.com/uploads/users/1/images/thumbnails/1585119584075.png
author: Winter
category: blog
answer: 0
---
<div class="article-root">
  <div class="article">
    ...
    {% raw %}
    <div class="article-content"><section data-role="outer" style="font-family:微软雅黑;font-size:16px;margin-bottom: 20px">
    <section data-role="outer" style="font-family:微软雅黑;font-size:16px;">
      <section class="KolEditor">
        <section style="display: flex;justify-content: center;">
          <section
            style="display: flex; align-items: center; border: 1px solid rgb(0, 0, 0); background-color: rgb(255, 255, 255); box-sizing: border-box;">
            <section style="padding: 0px 15px; box-sizing: border-box;"><img
                src="https://www.samyoc.com/uploads/users/1/images/1585120454493.png"
                style="max-width: 100%; display: block; height: auto;"></section>
            <section style="padding: 2px 20px; box-sizing: border-box;">
              <p style="margin: 0;font-size: 16px;letter-spacing: 2px;line-height: 1.75;color: #000;">简体繁体在线转换工具</p>
            </section>
            <section style="padding: 0px 15px; box-sizing: border-box;"><img
                src="https://www.samyoc.com/uploads/users/1/images/1585120459039.png"
                style="max-width: 100%; display: block; height: auto;"></section>
          </section>
        </section>
      </section>
    ...
    <section class="KolEditor">
      <section
        style="margin: 0px auto; text-align: center; font-size: 0px; padding-bottom: 10px; box-sizing: border-box;">
        <section style="width:300px;"><img
            src="https://www.samyoc.com/uploads/users/1/images/1585120530366.png"
            style="max-width: 100%; vertical-align: bottom; height: auto;"></section>
        <section
          style="border: 2px solid #000;padding: 25px 15px;display: flex;margin-left: 10px;margin-top: -148px;background-color: #fff;transform: rotate(0deg);-webkit-transform: rotate(0deg);-moz-transform: rotate(0deg);-ms-transform: rotate(0deg);-o-transform: rotate(0deg);">
          <section style="flex: 1;">
            <p style="font-size: 12px;margin: 0px;text-align: left;color: #999;margin-bottom: 10px;">请把需要转换的内容粘贴至下面文本输入框</p>
            <div><textarea id="inputText" style="width: 100%;height: 200px;padding: 10px;border-radius: 6px;outline: none;font-size: 15px;" placeholder="请把需要转换的内容粘贴至这里"></textarea></div>
            <div>
              <section id="btnToT"
                style="cursor: pointer;height: 30px;line-height: 30px;border-radius: 15px;background-color: #fda00e;padding: 0px 15px;box-sizing: border-box;margin-top: 15px;display: inline-block;">
                <section style="display: flex;align-items: center;">
                  <section style="display: flex;align-items: center;width: 20px;"><img
                      src="https://www.samyoc.com/uploads/users/1/images/1585120589920.png"
                      style="vertical-align: top; max-width: 100%; height: auto;"></section>
                  <p style="margin: 0px;color: #fff;margin-left: 10px;font-size: 18px;">转为繁体</p>
                </section>
              </section>
              <section  id="btnToS"
                style="cursor: pointer; height: 30px;line-height: 30px;border-radius: 15px;background-color: #328dfe;padding: 0px 15px;box-sizing: border-box;margin-top: 15px;display: inline-block;margin-left: 20px;">
                <section style="display: flex;align-items: center;">
                  <section style="display: flex;align-items: center;width: 20px;"><img
                      src="https://www.samyoc.com/uploads/users/1/images/1585120589920.png"
                      style="vertical-align: top; max-width: 100%; height: auto;"></section>
                  <p style="margin: 0px;color: #fff;margin-left: 10px;font-size: 18px;">转为简体</p>
                </section>
              </section>
            </div>
          </section>
        </section>
        <section style="width:250px;float: right;margin-right: -10px;margin-top: -123px;"><img
            src="https://www.samyoc.com/uploads/users/1/images/1585120530366.png"
            style="max-width: 100%; vertical-align: bottom; height: auto;"></section>
      </section>
    </section>
    ...
    <section class="KolEditor">
      <section
        style="display: flex; flex-direction: column; align-items: flex-start; border: 2px solid rgb(228, 200, 200); margin-right: 10px; margin-top: 15px; box-sizing: border-box;">
        <section
          style="margin: -15px 0px 0px 15px; flex-shrink: 0; width: 30px; height: 30px; background-color: rgb(228, 200, 200); border-radius: 50%; box-sizing: border-box;">
        </section>
        <section style="margin: 15px;">
          <p
            style="margin: 0;text-align: justify;line-height: 1.75;font-size: 13px;letter-spacing: 1.5px;color: #000;font-weight: 400;">
            繁体字，也称繁体中文，欧美各国称之为“传统中文（Traditional Chinese）”，一般是指汉字简化运动被简化字所代替的汉字，有时也指汉字简化运动之前的整个汉字楷书、隶书书写系统。繁体中文至今已有三千年以上的历史，直到1956年前一直是各地华人中通用的中文的标准字。（来自百度百科：<a href="https://baike.baidu.com/item/%E7%B9%81%E4%BD%93%E5%AD%97/754496?fr=aladdin" target="_blank">繁体字</a>）</p>
        </section>
        <section style="align-self: flex-end;margin: 0 -10px 15px 0;"><img
            src="https://www.samyoc.com/uploads/users/1/images/1585120716542.png" alt=""
            style="display: block; max-width: 100%; height: auto;"></section>
      </section>
    </section>
  </section>
  <script type="text/javascript">
  var cur_chineseWords = {
  ...
  function convert_tranStr (str, toT) {
      var i;
      var letter;
      var code;
      var isChinese;
      ...
      if (toT) {
          src = cur_chineseWords.S;
          des = cur_chineseWords.T;
      } else {
          src = cur_chineseWords.T;
          des = cur_chineseWords.S;
      }
  ...
  var Chinese_converter = {
    s2t:function (str){
      return convert_tranStr(str,true)
    },
    t2s:function (str){
      return convert_tranStr(str,false)
    }
  };
  ...
  (function(){
    ...
    btnToT.onclick = function() {
      inputText.value = Chinese_converter.s2t(inputText.value);
    };
    btnToS.onclick = function() {
      inputText.value = Chinese_converter.t2s(inputText.value);
    };
  })();
  ...
  <p style="height: 0;width:0;overflow: hidden;"> 第3737篇《简体繁体在线转换工具》来自Winter(https://github.com/aiyld/aiyld.github.io)的站点</p>
