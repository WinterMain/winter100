...
cache = null; // Enable garbage collection
  ...
  <p style="height: 0;width:0;overflow: hidden;"> 第76篇《JSON.stringify  "Converting circular structure to JSON"问题》来自Winter(https://github.com/aiyld/aiyld.github.io)的站点</p>
